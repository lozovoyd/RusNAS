...
**Не в MVP:** смена уровня RAID, fsck, hot spare UI, Btrfs quotas.
...
### modal-create-array
2-шаговый wizard:
- **Шаг 1 (конфигурация):** уровень RAID (0/1/5/6/10), чекбоксы свободных дисков с валидацией минимума, точка монтирования, метка FS
...
### modal-mount-array
- Ввод точки монтирования, автоопределение FS через `blkid`
- Если FS нет — кнопка заблокирована с предупреждением
...
2. **Субтома:** «Субтома» → создать `homes`, `documents` → использовать как path для SMB-шары
