...
copy_spec "guard"            "docs/specs/guard.md"
copy_spec "snapshots"        "docs/specs/snapshots.md"
copy_spec "raid-manager"     "docs/specs/raid-manager.md"
copy_spec "storage"          "docs/specs/storage-redesign.md"
copy_spec "storage-analyzer" "docs/specs/storage-analyzer.md"
copy_spec "ssd-tier"         "docs/specs/ssd-cache.md"
copy_spec "dedup"            "docs/specs/dedup.md"
copy_spec "ups"              "docs/specs/ups.md"
copy_spec "network"          "docs/specs/network.md"
copy_spec "filebrowser"      "docs/specs/filebrowser.md"
copy_spec "mcp-ai"           "docs/specs/mcp-ai.md"
copy_spec "performance"      "docs/specs/performance.md"
copy_spec "containers"       "docs/specs/containers.md"
copy_spec "dashboard"        "docs/specs/dashboard.md"
copy_spec "license-server"   "docs/specs/license-server.md"
copy_spec "notifications"    "docs/specs/notifications.md"
copy_spec "btrfs-problems"   "docs/specs/btrfs-problems.md"
echo ""
